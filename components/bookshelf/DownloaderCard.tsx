...
export const DownloaderCard = ({
    ...
    return (
        <div className={clsx('relative overflow-hidden rounded bg-white dark:bg-black dark:text-white shadow ring-0 ring-offset-0 ring-primary transition-shadow', selected && '!ring-4')}>
            ...
            <article className="flex flex-col h-full cursor-pointer" onClick={() => {setSelected(!selected)}}>
                ...
                <div className="mx-4 mb-4">
                    <header className="mb-2">
                        {doc && <Link href="/docs" className="float-right -mr-4 px-2 py-1 rounded-bl bg-primary text-white"><svg className="w-4 h-4 inline-block mr-1" aria-hidden="true" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
